const rewardDictionary = {
    ...
    id: {
      ...
      'polychrome': 'Polychrome',
      'mora': 'Mora',
      'mystic enhancement ore': 'Bijih Peningkatan Mistis',
      'hero\'s wit': 'Kecerdasan Pahlawan',
      'w-engine power supplies': 'Sumber Daya W-Engine',
      'bangboo algorithm module': 'Modul Algoritma Bangboo',
      'official investigator log': 'Log Investigator Resmi',
      'and': 'dan',
      'x': 'x',
      'vayuda turquoise sliver': 'Pecahan Pirus Vayuda',
      'guide to kindling': 'Panduan Perapian',
      'adventurer\'s experience': 'Pengalaman Petualang',
      'fine enhancement ore': 'Bijih Peningkatan Halus',
      'jueyun chili chicken': 'Ayam Cabai Jueyun',
      'stir-fried fish noodles': 'Mie Goreng Ikan',
      'kalpalata lotus': 'Teratai Kalpalata',
      'brilliant chrysanthemums': 'Krisan Cemerlang',
      'one': 'x1',
      'two': 'x2',
      'three': 'x3',
      'four': 'x4',
      ...
      'ten': 'x10',
      'fifteen': 'x15',
      'bottled soda': 'Soda Botol',
      'condensed aether': 'Aether Pekat',
      'lost gold fragments': 'Pecahan Emas Hilang',
      'credits': 'Kredit',
      'traveler\'s guides': 'Panduan Pengembara',
    },
  };
